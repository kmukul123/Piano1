...
namespace Manufaktura.Controls.WPF.Test1
{
    /// <summary>
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            var elements = noteViewer1.InnerScore.Staves.SelectMany(s => s.Elements).Where(x => x.Measure != null && x.Measure.System == noteViewer1.InnerScore.Systems[0]);
